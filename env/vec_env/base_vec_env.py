...
class VecEnv(ABC):
    ...
    def seed(self, seed: Optional[int] = None) -> List[Union[None, int]]:
        ...
        :return: (List[Union[None, int]]) Returns a list containing the seeds for each individual vec_env.
            Note that all list elements may be None, if the vec_env does not return anything when being seeded.
        """
        pass
