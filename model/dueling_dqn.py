...
class DuelingDQN:
    def __init__(
        ...
        self.inter_update = inter_update
    ...
    def step(self, s, a, r, s_, done):
        ...
        self.t_step = (self.t_step + 1) % self.inter_update
        if self.t_step == 0:
    ...
    def learn(self):
        ...
        index = self.memory_counter if self.memory_counter < self.memory_size else self.memory_size
        sample_index = np.random.choice(index, size=self.batch_size)
