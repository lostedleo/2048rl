...
class MuZeroConfig:
    def __init__(self, size=GAME_SISE):
        ...
        ### Game
        self.observation_shape = (1, GAME_SISE, GAME_SISE)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
        ...
        self.reduced_channels_reward = GAME_SISE ** 2  # Number of channels in reward head
        self.reduced_channels_value = GAME_SISE ** 2  # Number of channels in value head
        self.reduced_channels_policy = GAME_SISE ** 2  # Number of channels in policy head
...
class Game(AbstractGame):
    ...
    def __init__(self, seed=None):
        self.env = gym.make("game2048-v0", size=GAME_SISE)
        if seed is not None:
            self.env.seed(seed)
